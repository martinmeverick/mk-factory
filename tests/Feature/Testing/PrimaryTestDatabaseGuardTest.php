...
class PrimaryTestDatabaseGuardTest extends TestCase
{
    ...
    {
        // argv + explicit environment work on Windows and POSIX alike.
        // Keep the deliberate hostile endpoint inputs intact: the child guard,
        // not shell parsing or an omitted variable, must reject them.
        $process = new Process([
            PHP_BINARY, base_path('vendor/bin/phpunit'), '-c', 'phpunit.xml',
            'tests/Support/DestructiveMigrationProbeTest.php',
