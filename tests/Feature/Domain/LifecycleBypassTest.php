...
class LifecycleBypassTest extends TestCase
{
    ...
    public function test_issued_invoice_declares_no_unexpected_public_method(): void
    {
        $safe = [
            ...
            // Reviewed read-only regime/amount accessors; no lifecycle mutation.
            'vatRegime', 'isUsedGoodsMargin', 'marginAcquisitionTotalMoney',
            'marginBaseMoney', 'marginGrossMoney', 'marginVatMoney',
            'isEditable',
        ];
